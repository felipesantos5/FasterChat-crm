...
export function ModernProfitCard({ data }: ModernProfitCardProps) {
  ...
  return (
    <Card className="flex flex-col h-full shadow-lg border-gray-100 dark:border-gray-800 overflow-hidden relative">
      {/* Gradient accent top */}
      ...
      <CardHeader className="pb-2 pt-5 px-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="p-1.5 rounded-lg bg-gradient-to-br from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30">
              <DollarSign className="h-4 w-4 text-green-600 dark:text-green-400" />
            </div>
            <CardTitle className="text-sm font-semibold">Lucro em Vendas</CardTitle>
          </div>
          <div
            className={cn(
      ...
      <CardContent className="flex-1 px-4 pb-4">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex items-center gap-2 p-2.5 rounded-lg bg-green-50 dark:bg-green-900/10 border border-green-100 dark:border-green-800/20">
            ...
            <div className="flex items-center gap-2 p-2.5 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/30">
              <div className="p-1.5 bg-gray-100 dark:bg-gray-700/50 rounded-md">
