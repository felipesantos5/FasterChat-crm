    ...
    <Card className="flex flex-col h-full shadow-lg border-gray-100 dark:border-gray-800">
      <CardHeader className="pb-2 pt-4 px-4">
        <div className="flex items-center gap-2">
          <div className="p-1.5 rounded-lg bg-lime-100 dark:bg-lime-900/30">
            <CalendarCheck className="h-4 w-4 text-lime-600 dark:text-lime-400" />
          </div>
      ...
      <CardContent className="flex-1 px-4 pb-3">
        <div className="flex items-baseline gap-2 mb-1">
          ...
          {data.percentageChange !== 0 && (
            <span className={`flex items-center gap-0.5 text-xs font-medium ${isPositive ? "text-lime-600 dark:text-lime-400" : "text-gray-900 dark:text-gray-100"}`}>
          ...
          <div className="flex items-center gap-2 p-2 rounded-lg bg-gray-50 dark:bg-gray-800/50">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-baseline gap-1.5">
                ...
                {data.percentageChange !== 0 && (
                  <span className={`text-[10px] font-medium ${isPositive ? "text-lime-600" : "text-gray-900"}`}>
