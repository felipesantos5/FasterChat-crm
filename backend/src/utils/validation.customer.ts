...
export const importCustomersSchema = z.array(createCustomerSchema);
export const validateImportCustomers = (data: unknown) => {
  return importCustomersSchema.parse(data);
};
