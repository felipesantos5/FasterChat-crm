...
flowRouter.post('/:id/execute', asyncHandler(flowController.executeSingle.bind(flowController)));
...
flowRouter.post('/:id/duplicate', asyncHandler(flowController.duplicateFlow.bind(flowController)));
